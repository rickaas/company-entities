...
public class CompanyEntitiesParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("CompanyEntities");
  ...
  { 
    CompanyEntitiesParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = CompanyEntitiesParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = CompanyEntitiesParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(CompanyEntitiesParseControllerGenerated.class);
    }
  ...
  { 
    return CompanyEntitiesParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
